...
const Page19 = ({setPage}) => {

  return (
<>

    <img onClick={()=>setPage(20)} src={process.env.PUBLIC_URL + `/images/dalej.svg`}alt="" className="dalej" />
...
kolanowego zalecają stosowanie <span>siarczanu chondroityny <br /> lub siarczanu glukozaminy </span>z zastrzeżeniem:</h1>
     ...
     <div  className="button page05">
      ...
      <h1 style={{display:'inline-block'}}>nie powinny być<span > podawane </span > <br /> razem</h1>
     </div>
